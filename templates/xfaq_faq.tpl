<div class="xfaq">
    <div class="pad5 marg5 ui-widget-content ui-corner-all">
        <div class="pad5 marg5 ui-widget-header ui-corner-all"><{$smarty.const._AM_XFAQ_FAQ_QUESTION}> : <{$question}></div>
       ...
       <div class="pad5 marg5 ui-state-default ui-corner-all">
        ...
        <{$smarty.const._AM_XFAQ_FAQ_SUBMITTER}>: <a href="<{$xoops_url}>/userinfo.php?uid=<{$submitterid}>"><{$submittername}></a>
        <{if $ansuserid != 0}>
